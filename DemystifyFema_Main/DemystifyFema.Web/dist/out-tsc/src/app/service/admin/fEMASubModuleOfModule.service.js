...
var FEMASubModuleOfModuleAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function FEMASubModuleOfModuleAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    FEMASubModuleOfModuleAdminService.prototype.getFEMASubModuleOfModule = function (getFEMASubModuleOfModuleRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/femasubmoduleofmodules", { params: params });
    };
    FEMASubModuleOfModuleAdminService.prototype.addFEMASubModuleOfModule = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/femasubmoduleofmodules/add", body, { headers: headers });
    };
    FEMASubModuleOfModuleAdminService.prototype.updateFEMASubModuleOfModule = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/femasubmoduleofmodules/update", body, { headers: headers });
    };
    FEMASubModuleOfModuleAdminService.prototype.deleteFEMASubModuleOfModule = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/femasubmoduleofmodules/delete", body, { headers: headers });
    };
    FEMASubModuleOfModuleAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], FEMASubModuleOfModuleAdminService);
    return FEMASubModuleOfModuleAdminService;
}());
exports.FEMASubModuleOfModuleAdminService = FEMASubModuleOfModuleAdminService;
