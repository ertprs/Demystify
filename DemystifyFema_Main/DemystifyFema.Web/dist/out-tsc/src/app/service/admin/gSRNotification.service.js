...
var GSRNotificationAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function GSRNotificationAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    GSRNotificationAdminService.prototype.getGSRNotification = function (getGSRNotificationRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/gsrnotifications", { params: params });
    };
    GSRNotificationAdminService.prototype.addGSRNotification = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/gsrnotifications/add", body, { headers: headers });
    };
    GSRNotificationAdminService.prototype.updateGSRNotification = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/gsrnotifications/update", body, { headers: headers });
    };
    GSRNotificationAdminService.prototype.deleteGSRNotification = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/gsrnotifications/delete", body, { headers: headers });
    };
    GSRNotificationAdminService.prototype.fileUpload = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/gsrnotifications/uploadfiles", formData);
    };
    GSRNotificationAdminService.prototype.getGSRNotificationType = function (getGSRNotificationTypeRequest) {
        //let headers = new Headers({ 'Authorization': this._global.getToken() });
        //let search = new URLSearchParams();
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/gsrnotificationtypes", { params: params });
    };
    GSRNotificationAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], GSRNotificationAdminService);
    return GSRNotificationAdminService;
}());
exports.GSRNotificationAdminService = GSRNotificationAdminService;
