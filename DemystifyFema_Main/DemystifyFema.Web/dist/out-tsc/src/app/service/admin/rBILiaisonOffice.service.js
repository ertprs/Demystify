...
var RBILiaisonOfficeAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function RBILiaisonOfficeAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    RBILiaisonOfficeAdminService.prototype.getRBILiaisonOffice = function (getRBILiaisonOfficeRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/rbiliaisonoffices", { params: params });
    };
    RBILiaisonOfficeAdminService.prototype.addRBILiaisonOfficeFromExcel = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/rbiliaisonoffices/addfromexcel", formData);
    };
    RBILiaisonOfficeAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], RBILiaisonOfficeAdminService);
    return RBILiaisonOfficeAdminService;
}());
exports.RBILiaisonOfficeAdminService = RBILiaisonOfficeAdminService;
//# sourceMappingURL=rBILiaisonOffice.service.js.map