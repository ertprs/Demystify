...
var PressNoteNotificationAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function PressNoteNotificationAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    PressNoteNotificationAdminService.prototype.getPressNoteNotification = function (getPressNoteNotificationRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/pressnotenotifications", { params: params });
    };
    PressNoteNotificationAdminService.prototype.addPressNoteNotification = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/pressnotenotifications/add", body, { headers: headers });
    };
    PressNoteNotificationAdminService.prototype.updatePressNoteNotification = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/pressnotenotifications/update", body, { headers: headers });
    };
    PressNoteNotificationAdminService.prototype.deletePressNoteNotification = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/pressnotenotifications/delete", body, { headers: headers });
    };
    PressNoteNotificationAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], PressNoteNotificationAdminService);
    return PressNoteNotificationAdminService;
}());
exports.PressNoteNotificationAdminService = PressNoteNotificationAdminService;
//# sourceMappingURL=pressNoteNotification.service.js.map