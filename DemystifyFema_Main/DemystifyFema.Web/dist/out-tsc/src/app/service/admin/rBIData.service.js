...
var RBIDataAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function RBIDataAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    RBIDataAdminService.prototype.getRBIData = function (getRBIDataRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/rbidatas", { params: params });
    };
    RBIDataAdminService.prototype.addRBIData = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/rbidatas/add", body, { headers: headers });
    };
    RBIDataAdminService.prototype.updateRBIData = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/rbidatas/update", body, { headers: headers });
    };
    RBIDataAdminService.prototype.deleteRBIData = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/rbidatas/delete", body, { headers: headers });
    };
    RBIDataAdminService.prototype.fileUpload = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/rbidatas/uploadfiles", formData);
    };
    RBIDataAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], RBIDataAdminService);
    return RBIDataAdminService;
}());
exports.RBIDataAdminService = RBIDataAdminService;
