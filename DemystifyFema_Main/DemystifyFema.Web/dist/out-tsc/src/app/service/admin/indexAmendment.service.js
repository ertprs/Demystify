...
var IndexAmendmentAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function IndexAmendmentAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    IndexAmendmentAdminService.prototype.getIndexAmendment = function (getIndexAmendmentRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/indexamendments", { params: params });
    };
    IndexAmendmentAdminService.prototype.getAmendmentContent = function (getAmendmentContentRequest) {
        //let headers = new Headers({ 'Authorization': this._global.getToken() });
        //let search = new URLSearchParams();
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/amendmentcontents", { params: params });
    };
    IndexAmendmentAdminService.prototype.addIndexAmendment = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/indexamendments/add", body, { headers: headers });
    };
    IndexAmendmentAdminService.prototype.updateIndexAmendment = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/indexamendments/update", body, { headers: headers });
    };
    IndexAmendmentAdminService.prototype.deleteIndexAmendment = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/indexamendments/delete", body, { headers: headers });
    };
    IndexAmendmentAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], IndexAmendmentAdminService);
    return IndexAmendmentAdminService;
}());
exports.IndexAmendmentAdminService = IndexAmendmentAdminService;
//# sourceMappingURL=indexAmendment.service.js.map