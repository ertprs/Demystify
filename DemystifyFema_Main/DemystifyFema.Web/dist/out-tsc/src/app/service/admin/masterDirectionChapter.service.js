...
var MasterDirectionChapterAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function MasterDirectionChapterAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    MasterDirectionChapterAdminService.prototype.getMasterDirectionChapter = function (getMasterDirectionChapterRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/masterdirectionchapters", { params: params });
    };
    MasterDirectionChapterAdminService.prototype.addMasterDirectionChapter = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirectionchapters/add", body, { headers: headers });
    };
    MasterDirectionChapterAdminService.prototype.updateMasterDirectionChapter = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirectionchapters/update", body, { headers: headers });
    };
    MasterDirectionChapterAdminService.prototype.deleteMasterDirectionChapter = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirectionchapters/delete", body, { headers: headers });
    };
    MasterDirectionChapterAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], MasterDirectionChapterAdminService);
    return MasterDirectionChapterAdminService;
}());
exports.MasterDirectionChapterAdminService = MasterDirectionChapterAdminService;
//# sourceMappingURL=masterDirectionChapter.service.js.map