...
var FIPBReviewAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function FIPBReviewAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    FIPBReviewAdminService.prototype.getFIPBReview = function (getFIPBReviewRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/fipbreviews", { params: params });
    };
    FIPBReviewAdminService.prototype.addFIPBReview = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fipbreviews/add", body, { headers: headers });
    };
    FIPBReviewAdminService.prototype.updateFIPBReview = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fipbreviews/update", body, { headers: headers });
    };
    FIPBReviewAdminService.prototype.deleteFIPBReview = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fipbreviews/delete", body, { headers: headers });
    };
    FIPBReviewAdminService.prototype.fileUpload = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fipbreviews/uploadfiles", formData);
    };
    FIPBReviewAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], FIPBReviewAdminService);
    return FIPBReviewAdminService;
}());
exports.FIPBReviewAdminService = FIPBReviewAdminService;
