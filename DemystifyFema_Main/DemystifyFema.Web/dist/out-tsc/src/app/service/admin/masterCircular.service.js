...
var MasterCircularAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function MasterCircularAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    MasterCircularAdminService.prototype.getMasterCircular = function (getMasterCircularRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/mastercirculars", { params: params });
    };
    MasterCircularAdminService.prototype.addMasterCircular = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/mastercirculars/add", body, { headers: headers });
    };
    MasterCircularAdminService.prototype.updateMasterCircular = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/mastercirculars/update", body, { headers: headers });
    };
    MasterCircularAdminService.prototype.deleteMasterCircular = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/mastercirculars/delete", body, { headers: headers });
    };
    MasterCircularAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], MasterCircularAdminService);
    return MasterCircularAdminService;
}());
exports.MasterCircularAdminService = MasterCircularAdminService;
//# sourceMappingURL=masterCircular.service.js.map