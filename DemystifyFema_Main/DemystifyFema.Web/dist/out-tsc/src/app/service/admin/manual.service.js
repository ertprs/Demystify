...
var ManualAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function ManualAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    ManualAdminService.prototype.getManual = function (getManualRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/manuals", { params: params });
    };
    ManualAdminService.prototype.addManual = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/manuals/add", body, { headers: headers });
    };
    ManualAdminService.prototype.updateManual = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/manuals/update", body, { headers: headers });
    };
    ManualAdminService.prototype.deleteManual = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/manuals/delete", body, { headers: headers });
    };
    ManualAdminService.prototype.fileUpload = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/manuals/uploadfiles", formData);
    };
    ManualAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], ManualAdminService);
    return ManualAdminService;
}());
exports.ManualAdminService = ManualAdminService;
