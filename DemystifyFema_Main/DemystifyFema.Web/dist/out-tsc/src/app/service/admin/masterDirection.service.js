...
var MasterDirectionAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function MasterDirectionAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    MasterDirectionAdminService.prototype.getMasterDirection = function (getMasterDirectionRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/masterdirections", { params: params });
    };
    MasterDirectionAdminService.prototype.addMasterDirection = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirections/add", body, { headers: headers });
    };
    MasterDirectionAdminService.prototype.updateMasterDirection = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirections/update", body, { headers: headers });
    };
    MasterDirectionAdminService.prototype.deleteMasterDirection = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirections/delete", body, { headers: headers });
    };
    MasterDirectionAdminService.prototype.fileUpload = function (formData) {
        ...
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/masterdirections/uploadfiles", formData);
    };
    MasterDirectionAdminService.prototype.getMasterDirectionYear = function () {
        //let headers = new Headers({ 'Authorization': this._global.getToken() });
        //let requestOptions = new RequestOptions();
        //requestOptions.headers = headers;
        //return this._http.get(Global.API_SITE + "admin/api/masterdirectionyears", requestOptions)
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/masterdirectionyears");
    };
    MasterDirectionAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], MasterDirectionAdminService);
    return MasterDirectionAdminService;
}());
exports.MasterDirectionAdminService = MasterDirectionAdminService;
//# sourceMappingURL=masterDirection.service.js.map