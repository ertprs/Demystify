...
var FAQCategoryAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function FAQCategoryAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    FAQCategoryAdminService.prototype.getFAQCategory = function (getFAQCategoryRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/faqcategories", { params: params });
    };
    FAQCategoryAdminService.prototype.addFAQCategory = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/faqcategories/add", body, { headers: headers });
    };
    FAQCategoryAdminService.prototype.updateFAQCategory = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/faqcategories/update", body, { headers: headers });
    };
    FAQCategoryAdminService.prototype.deleteFAQCategory = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/faqcategories/delete", body, { headers: headers });
    };
    FAQCategoryAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], FAQCategoryAdminService);
    return FAQCategoryAdminService;
}());
exports.FAQCategoryAdminService = FAQCategoryAdminService;
//# sourceMappingURL=fAQCategory.service.js.map