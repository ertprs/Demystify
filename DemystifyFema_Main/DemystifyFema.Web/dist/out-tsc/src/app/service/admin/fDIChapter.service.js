...
var FDIChapterAdminService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function FDIChapterAdminService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    FDIChapterAdminService.prototype.getFDIChapter = function (getFDIChapterRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "admin/api/fdichapters", { params: params });
    };
    FDIChapterAdminService.prototype.addFDIChapter = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fdichapters/add", body, { headers: headers });
    };
    FDIChapterAdminService.prototype.updateFDIChapter = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fdichapters/update", body, { headers: headers });
    };
    FDIChapterAdminService.prototype.deleteFDIChapter = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "admin/api/fdichapters/delete", body, { headers: headers });
    };
    FDIChapterAdminService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], FDIChapterAdminService);
    return FDIChapterAdminService;
}());
exports.FDIChapterAdminService = FDIChapterAdminService;
//# sourceMappingURL=fDIChapter.service.js.map