...
var ContactUsService = /** @class */ (function () {
    ...
    function ContactUsService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    ContactUsService.prototype.getContactUs = function (getContactUsRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "api/contactuss", { params: params });
    };
    ContactUsService.prototype.addContactUs = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "api/contactuss/add", body, { headers: headers });
    };
    ContactUsService.prototype.deleteContactUs = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "api/contactuss/delete", body, { headers: headers });
    };
