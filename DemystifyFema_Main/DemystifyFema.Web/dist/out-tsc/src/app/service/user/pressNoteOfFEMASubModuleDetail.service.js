...
var PressNoteOfFEMASubModuleDetailUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function PressNoteOfFEMASubModuleDetailUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    PressNoteOfFEMASubModuleDetailUserService.prototype.getPressNoteOfFEMASubModuleDetail = function (getFEMASubModuleDetailRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/pressnotes", { params: params });
    };
    PressNoteOfFEMASubModuleDetailUserService.prototype.getPressNoteYears = function () {
        //let headers = new Headers({ 'Authorization': this._global.getUserToken() });
        //let requestOptions = new RequestOptions();
        //requestOptions.headers = headers;
        //return this._http.get(Global.API_SITE + "user/api/pressnoteyears", requestOptions)
        //    .pipe(map((response: Response) => <any>response.json()), catchError(e => throwError(e)));
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/pressnoteyears");
    };
    PressNoteOfFEMASubModuleDetailUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], PressNoteOfFEMASubModuleDetailUserService);
    return PressNoteOfFEMASubModuleDetailUserService;
}());
exports.PressNoteOfFEMASubModuleDetailUserService = PressNoteOfFEMASubModuleDetailUserService;
//# sourceMappingURL=pressNoteOfFEMASubModuleDetail.service.js.map