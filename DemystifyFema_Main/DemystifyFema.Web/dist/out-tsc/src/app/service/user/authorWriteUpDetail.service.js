...
var AuthorWriteUpDetailUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function AuthorWriteUpDetailUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    AuthorWriteUpDetailUserService.prototype.getAuthorWriteUpDetail = function (getAuthorWriteUpDetailRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/authorwriteupdetails", { params: params });
    };
    AuthorWriteUpDetailUserService.prototype.getSubTopic = function (getSubTopicRequest) {
        //let headers = new Headers({ 'Authorization': this._global.getUserToken() });
        //let search = new URLSearchParams();
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/subTopics", { params: params });
    };
    AuthorWriteUpDetailUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], AuthorWriteUpDetailUserService);
    return AuthorWriteUpDetailUserService;
}());
exports.AuthorWriteUpDetailUserService = AuthorWriteUpDetailUserService;
