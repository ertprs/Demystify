...
var SupportTicketReplyUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function SupportTicketReplyUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    SupportTicketReplyUserService.prototype.getSupportTicketReply = function (getSupportTicketReplyRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/supportticketreplies", { params: params });
    };
    SupportTicketReplyUserService.prototype.addSupportTicketReply = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "user/api/supportticketreplies/add", body, { headers: headers });
    };
    SupportTicketReplyUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], SupportTicketReplyUserService);
    return SupportTicketReplyUserService;
}());
exports.SupportTicketReplyUserService = SupportTicketReplyUserService;
