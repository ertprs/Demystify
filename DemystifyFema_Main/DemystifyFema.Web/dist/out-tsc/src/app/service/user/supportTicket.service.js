...
var SupportTicketUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function SupportTicketUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    SupportTicketUserService.prototype.getSupportTicket = function (getSupportTicketRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/supporttickets", { params: params });
    };
    SupportTicketUserService.prototype.addSupportTicket = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "user/api/supporttickets/add", body, { headers: headers });
    };
    SupportTicketUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], SupportTicketUserService);
    return SupportTicketUserService;
}());
exports.SupportTicketUserService = SupportTicketUserService;
