...
var RBIFAQOfFEMASubModuleDetailUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function RBIFAQOfFEMASubModuleDetailUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    RBIFAQOfFEMASubModuleDetailUserService.prototype.getRBIFAQOfFEMASubModuleDetail = function (getFEMASubModuleDetailRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/rbifaqoffemasubmoduledetails", { params: params });
    };
    RBIFAQOfFEMASubModuleDetailUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], RBIFAQOfFEMASubModuleDetailUserService);
    return RBIFAQOfFEMASubModuleDetailUserService;
}());
exports.RBIFAQOfFEMASubModuleDetailUserService = RBIFAQOfFEMASubModuleDetailUserService;
//# sourceMappingURL=rBIFAQOfFEMASubModuleDetail.service.js.map