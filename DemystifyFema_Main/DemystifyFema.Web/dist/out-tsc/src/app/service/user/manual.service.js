...
var ManualUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function ManualUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    ManualUserService.prototype.getManual = function (getManualRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/manuals", { params: params });
    };
    ManualUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], ManualUserService);
    return ManualUserService;
}());
exports.ManualUserService = ManualUserService;
