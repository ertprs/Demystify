...
var UserProfileUserService = /** @class */ (function () {
    //constructor(private _http: Http) { }
    function UserProfileUserService(_httpClient) {
        this._httpClient = _httpClient;
        this._global = new global_1.Global();
    }
    UserProfileUserService.prototype.getUserProfile = function (getUserProfileRequest) {
        ...
        return this._httpClient.get(global_1.Global.API_SITE + "user/api/userprofiles", { params: params });
    };
    UserProfileUserService.prototype.updateProfile = function (model) {
        ...
        return this._httpClient.post(global_1.Global.API_SITE + "user/api/userprofiles/update", body, { headers: headers });
    };
    UserProfileUserService.prototype.sendOTPForUserProfile = function (model) {
        //let body = JSON.stringify(model);
        //let headers = new Headers({ 'Content-Type': 'application/json', 'Authorization': this._global.getUserToken() });
        //let options = new RequestOptions({ headers: headers });
        ...
        var body = JSON.stringify(model);
        var headers = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        return this._httpClient.post(global_1.Global.API_SITE + "user/api/sendotpforuserprofile", body, { headers: headers });
    };
    UserProfileUserService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], UserProfileUserService);
    return UserProfileUserService;
}());
exports.UserProfileUserService = UserProfileUserService;
