...
var KeyDefinitionPopupUserComponent = /** @class */ (function () {
    function KeyDefinitionPopupUserComponent(formBuilder, toastr, vcr, _keyDefinitionEventService, spinnerService, modalService) {
    ...
    KeyDefinitionPopupUserComponent.prototype.dialogInit = function (reference, options) {
        this.frmKeyDefinitionEvent = this.formBuilder.group({
            SearchText: [this.searchText]
        });
        this.GetKeyDefinitionEvent();
    };
    KeyDefinitionPopupUserComponent.prototype.GetKeyDefinitionEvent = function (searchText, pageNumber) {
        var _this = this;
    ...
    KeyDefinitionPopupUserComponent.prototype.SearchKeyDefinitionEvent = function (formData) {
        this.currentPage = 1;
        this.searchText = formData.value.SearchText;
        this.GetKeyDefinitionEvent(this.searchText, this.currentPage);
    };
    KeyDefinitionPopupUserComponent.prototype.OnPageChange = function (pageNumber) {
        this.currentPage = pageNumber;
        this.GetKeyDefinitionEvent(this.searchText, pageNumber);
    };
    KeyDefinitionPopupUserComponent.prototype.OnPageSizeChange = function () {
        this.currentPage = 1;
        this.GetKeyDefinitionEvent(this.searchText, null);
    };
    KeyDefinitionPopupUserComponent.prototype.OnKeyDefinitionEventSort = function (fieldName) {
    ...
    KeyDefinitionPopupUserComponent.prototype.ShowContent = function (content) {
        this.content = content;
    };
    KeyDefinitionPopupUserComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return KeyDefinitionPopupUserComponent;
}());
exports.KeyDefinitionPopupUserComponent = KeyDefinitionPopupUserComponent;
//# sourceMappingURL=keyDefinitionPopup.component.js.map