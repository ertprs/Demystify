...
var TermsConditionPopupUserComponent = /** @class */ (function () {
    function TermsConditionPopupUserComponent(router, _termsConditionService, spinnerService, toastr) {
        this.router = router;
    ...
    TermsConditionPopupUserComponent.prototype.ngOnInit = function () {
        this.GettermsCondition();
    };
    TermsConditionPopupUserComponent.prototype.dialogInit = function (refernce, options) {
        options.actionButtons = [{
                text: "x", buttonClass: "waves-effect ml-auto close-button pointer-cursor"
            }];
    };
    TermsConditionPopupUserComponent.prototype.GettermsCondition = function () {
        var _this = this;
        this._termsConditionService.getTermsCondition_Guest()
            ...
            if (data.Status == global_1.Global.API_SUCCESS) {
                ...
                if (data.Response.length > 0) {
                    ...
                    ID.innerHTML = global_1.Global.TOASTR_ADMIN_NO_TERMS_CONDITION_FOUND;
                }
            }
            else {
                _this.spinnerService.hide();
    ...
    TermsConditionPopupUserComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return TermsConditionPopupUserComponent;
}());
exports.TermsConditionPopupUserComponent = TermsConditionPopupUserComponent;
//# sourceMappingURL=termsConditionPopup.component.js.map