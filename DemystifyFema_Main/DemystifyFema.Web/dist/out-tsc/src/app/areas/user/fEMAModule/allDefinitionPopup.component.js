...
var AllDefinitionPopupUserComponent = /** @class */ (function () {
    function AllDefinitionPopupUserComponent(formBuilder, toastr, vcr, _rBICompoundingOrderService, spinnerService, modalService) {
        ...
        this.moduleTab = "content";
    }
    AllDefinitionPopupUserComponent.prototype.dialogInit = function (reference, options) {
        this.frmRBICompoundingOrder = this.formBuilder.group({
            SearchText: [this.searchText]
        });
        this.GetRBICompoundingOrder();
    };
    AllDefinitionPopupUserComponent.prototype.GetRBICompoundingOrder = function (searchText, pageNumber) {
        var _this = this;
    ...
    AllDefinitionPopupUserComponent.prototype.SearchRBICompoundingOrder = function (formData) {
        this.currentPage = 1;
        this.searchText = formData.value.SearchText;
        this.GetRBICompoundingOrder(this.searchText, this.currentPage);
    };
    AllDefinitionPopupUserComponent.prototype.OnPageChange = function (pageNumber) {
        this.currentPage = pageNumber;
        this.GetRBICompoundingOrder(this.searchText, pageNumber);
    };
    AllDefinitionPopupUserComponent.prototype.OnPageSizeChange = function () {
        this.currentPage = 1;
        this.GetRBICompoundingOrder(this.searchText, null);
    };
    AllDefinitionPopupUserComponent.prototype.OnRBICompoundingOrderSort = function (fieldName) {
    ...
    AllDefinitionPopupUserComponent.prototype.ShowContent = function (content) {
        this.content = content;
    };
    AllDefinitionPopupUserComponent.prototype.OnModuleTabClick = function (moduleTab) {
        this.moduleTab = moduleTab;
    };
    AllDefinitionPopupUserComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
            templateUrl: './allDefinitionPopup.component.html'
        }),
    ...
    ], AllDefinitionPopupUserComponent);
    return AllDefinitionPopupUserComponent;
}());
exports.AllDefinitionPopupUserComponent = AllDefinitionPopupUserComponent;
//# sourceMappingURL=allDefinitionPopup.component.js.map