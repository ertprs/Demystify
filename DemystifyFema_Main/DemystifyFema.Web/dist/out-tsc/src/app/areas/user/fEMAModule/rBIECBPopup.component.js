...
var RBIECBPopupUserComponent = /** @class */ (function () {
    function RBIECBPopupUserComponent(_spinnerService, _toastrService, _rBIDataService, sanitizer) {
    ...
    RBIECBPopupUserComponent.prototype.dialogInit = function (refernce, options) {
        this.GetRBIDataDetailYear();
    };
    RBIECBPopupUserComponent.prototype.GetRBIDataDetailYear = function () {
        var _this = this;
    ...
    RBIECBPopupUserComponent.prototype.GetRBIDataDetailMonth = function () {
        this.rBIDataDetailMonths = [];
    ...
    RBIECBPopupUserComponent.prototype.GetRBIDataDetail = function () {
        var _this = this;
        this._spinnerService.show();
        ...
        this._rBIDataService.getRBIData(getRBIDataRequest)
            ...
            var rBIDataId = (data.Response.length > 0) ? data.Response.filter(function (x) { return x.RBIDataName == global_1.Global.RBIDATA_ECB_NAME; })[0].RBIDataId : null;
    ...
    RBIECBPopupUserComponent.prototype.OnChangeRBIDataDetailYear = function (year) {
        this.rBIDataDetail = new rBIDataDetail_1.RBIDataDetail();
        this.year = year;
        this.GetRBIDataDetail();
    };
    RBIECBPopupUserComponent.prototype.OnChangeRBIDataDetailMonth = function (month) {
        this.rBIDataDetail = new rBIDataDetail_1.RBIDataDetail();
        this.month = month;
        this.GetRBIDataDetail();
    };
    RBIECBPopupUserComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
            templateUrl: './rBIECBPopup.component.html'
        }),
    ...
    return RBIECBPopupUserComponent;
}());
exports.RBIECBPopupUserComponent = RBIECBPopupUserComponent;
//# sourceMappingURL=rBIECBPopup.component.js.map