...
var PostQueryReplyAdminComponent = /** @class */ (function () {
    function PostQueryReplyAdminComponent(formBuilder, toastr, activatedRoute, router, _supportTicketService, _supportTicketReplyService, vcr, spinnerService) {
    ...
    PostQueryReplyAdminComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PostQueryReplyAdminComponent.prototype.GetSupportTicket = function () {
        var _this = this;
    ...
    PostQueryReplyAdminComponent.prototype.GetSupportTicketReply = function () {
        var _this = this;
        this.spinnerService.show();
    ...
    PostQueryReplyAdminComponent.prototype.DeleteSupportTicketReply = function (supportTicketReplyId) {
        var _this = this;
    ...
    PostQueryReplyAdminComponent.prototype.SaveSupportTicketReply = function (formData) {
        var _this = this;
        this.spinnerService.show();
    ...
    PostQueryReplyAdminComponent.prototype.OnClickPostReply = function () {
        this.isSendReply = true;
    };
    PostQueryReplyAdminComponent.prototype.CancelPostReply = function () {
        this.isSendReply = false;
    };
    PostQueryReplyAdminComponent.prototype.OnSubmitSupportTicketReply = function (formData) {
    ...
    PostQueryReplyAdminComponent.prototype.CancelSupportTicketReply = function () {
        var _this = this;
        this.activatedRoute.queryParams.subscribe(function (params) {
            _this.router.navigate(['/admin/secure/postquery'], {
                queryParams: {
    ...
    PostQueryReplyAdminComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
            templateUrl: './postQueryReply.component.html'
        }),
    ...
    return PostQueryReplyAdminComponent;
}());
exports.PostQueryReplyAdminComponent = PostQueryReplyAdminComponent;
//# sourceMappingURL=postQueryReply.component.js.map