...
var KeyDefinitionAdminComponent = /** @class */ (function () {
    ...
    KeyDefinitionAdminComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.frmKeyDefinitionEvent = this.formBuilder.group({
            ...
            DefinitionEventName: [global_1.Global.KEY_DEFINITION_FIELDNAME],
            DefinitionName: ['', forms_1.Validators.required],
            DefinitionAuthorNote: ['', forms_1.Validators.required],
            DefinitionContent: ['', forms_1.Validators.required],
    ...
    KeyDefinitionAdminComponent.prototype.GetKeyDefinitionEventModule = function (keyDefinitionEventData) {
        var _this = this;
    ...
    KeyDefinitionAdminComponent.prototype.onModuleSelect = function (item) {
        this.selectedModuleIds.push(item.Value);
        this.OnModuleChange(null);
    };
    KeyDefinitionAdminComponent.prototype.onModuleDeSelect = function (item) {
        this.selectedModuleIds = this.selectedModuleIds.filter(function (x) { return x.toString() !== item.Value.toString(); }).sort();
        this.OnModuleChange(null);
    };
    KeyDefinitionAdminComponent.prototype.OnModuleChange = function (keyDefinitionEventData) {
    ...
    KeyDefinitionAdminComponent.prototype.GetNotification = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetGSRNotification = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetFDICircular = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetPressNote = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetActName = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetMasterDirection = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.GetAPDIRCircular = function (keyDefinitionEventData) {
        var _this = this;
        this.spinnerService.show();
    ...
    KeyDefinitionAdminComponent.prototype.EditKeyDefinitionEvent = function (keyDefinitionEventId) {
        var _this = this;
        this.spinnerService.show();
        ...
        this._keyDefinitionEventService.getKeyDefinitionEvent(getKeyDefinitionEventRequest)
            ...
            _this.frmKeyDefinitionEvent.setValue({
                ...
                DefinitionAuthorNote: data.Response[0].DefinitionAuthorNote,
                DefinitionContent: data.Response[0].DefinitionContent,
                ModuleIds: [],
                NotificationIds: [],
                GSRNotificationIds: [],
                FDICircularIds: [],
    ...
    KeyDefinitionAdminComponent.prototype.SaveKeyDefinitionEvent = function (formData) {
        var _this = this;
        this.spinnerService.show();
            ...
            this._keyDefinitionEventService.updateKeyDefinitionEvent(formData.value)
                ...
                if (data.Status == global_1.Global.API_SUCCESS) {
                    _this.activatedRoute.queryParams.subscribe(function (params) {
                        _this.router.navigate(['/admin/secure/keydefinitions']).then(function () {
                    ...
                    _this.spinnerService.hide();
                    _this.toastr.error(data.Description, global_1.Global.TOASTR_ADMIN_KEY_DEFINITION_TITLE);
                }
            }, function (error) {
                _this.spinnerService.hide();
                _this.toastr.error(global_1.Global.ERROR_MESSAGE, global_1.Global.TOASTR_ADMIN_KEY_DEFINITION_TITLE, { enableHtml: true });
            });
        }
        else {
    ...
    KeyDefinitionAdminComponent.prototype.OnSubmitKeyDefinitionEvent = function (formData) {
    ...
    KeyDefinitionAdminComponent.prototype.CancelKeyDefinitionEvent = function () {
        this.router.navigate(['/admin/secure/keydefinitions']);
    };
    KeyDefinitionAdminComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
            templateUrl: './keyDefinition.component.html'
        }),
    ...
    return KeyDefinitionAdminComponent;
}());
exports.KeyDefinitionAdminComponent = KeyDefinitionAdminComponent;
//# sourceMappingURL=keyDefinition.component.js.map