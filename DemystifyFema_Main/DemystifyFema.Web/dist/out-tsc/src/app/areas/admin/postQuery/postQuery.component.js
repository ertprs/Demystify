...
var PostQueryAdminComponent = /** @class */ (function () {
    function PostQueryAdminComponent(formBuilder, activatedRoute, _supportTicketService, toastr, vcr, spinnerService, router) {
    ...
    PostQueryAdminComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PostQueryAdminComponent.prototype.GetSupportTicket = function (searchText, pageNumber, pageSize) {
        var _this = this;
    ...
    PostQueryAdminComponent.prototype.SearchSupportTicket = function (formData) {
        this.currentPage = 1;
        this.searchText = formData.value.SearchText;
        this.GetSupportTicket(this.searchText, this.currentPage, this.pageSize);
    };
    PostQueryAdminComponent.prototype.OnPageChange = function (pageNumber) {
        this.currentPage = pageNumber;
        this.GetSupportTicket(this.searchText, pageNumber, this.pageSize);
    };
    PostQueryAdminComponent.prototype.OnPageSizeChange = function () {
        this.currentPage = 1;
        this.pageSize = this.drpPageSize;
        this.GetSupportTicket(this.searchText, null, this.pageSize);
    };
    PostQueryAdminComponent.prototype.ViewSupportTicket = function (supportTicketId) {
    ...
    PostQueryAdminComponent.prototype.DeleteSupportTicket = function (supportTicketId) {
        var _this = this;
    ...
    PostQueryAdminComponent.prototype.OnSupportTicketSort = function (fieldName) {
    ...
    PostQueryAdminComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return PostQueryAdminComponent;
}());
exports.PostQueryAdminComponent = PostQueryAdminComponent;
//# sourceMappingURL=postQuery.component.js.map