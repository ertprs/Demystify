...
var ActNameAdminComponent = /** @class */ (function () {
    function ActNameAdminComponent(formBuilder, toastr, activatedRoute, router, _actNameService, vcr, spinnerService, _cookieService) {
    ...
    ActNameAdminComponent = __decorate([
        ...
        __metadata("design:paramtypes", [forms_1.FormBuilder, ngx_toastr_1.ToastrService, router_1.ActivatedRoute, router_1.Router, actName_service_1.ActNameAdminService, core_1.ViewContainerRef, spinner_service_1.SpinnerService, ngx_cookie_service_1.CookieService])
