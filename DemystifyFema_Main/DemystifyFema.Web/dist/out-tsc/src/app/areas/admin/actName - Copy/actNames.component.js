...
var ActNamesAdminComponent = /** @class */ (function () {
    function ActNamesAdminComponent(formBuilder, activatedRoute, _actNameService, _allDefinitionService, toastr, vcr, spinnerService, _cookieService, router, modalService) {
    ...
    ActNamesAdminComponent = __decorate([
        ...
        __metadata("design:paramtypes", [forms_1.FormBuilder, router_1.ActivatedRoute, actName_service_1.ActNameAdminService, allDefinition_service_1.AllDefinitionAdminService, ngx_toastr_1.ToastrService, core_1.ViewContainerRef, spinner_service_1.SpinnerService, ngx_cookie_service_1.CookieService, router_1.Router, ngx_modal_dialog_1.ModalDialogService])
