...
export class KeyDefinitionAdminComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.frmKeyDefinitionEvent = this.formBuilder.group({
            ...
            DefinitionEventName: [Global.KEY_DEFINITION_FIELDNAME],
            DefinitionName: ['', Validators.required],
            DefinitionAuthorNote: ['', Validators.required],
            DefinitionContent: ['', Validators.required],
                ...
                .subscribe(data => {
                    ...
                    if (data.Status == Global.API_SUCCESS) {
                        this.activatedRoute.queryParams.subscribe(params => {
                            this.router.navigate(['/admin/secure/keydefinitions']).then(() => {
                                this.toastr.success(data.Description, Global.TOASTR_ADMIN_KEY_DEFINITION_TITLE, { closeButton: true });
                            });
                        });
                    } else {
                        this.spinnerService.hide();
                        this.toastr.error(data.Description, Global.TOASTR_ADMIN_KEY_DEFINITION_TITLE);
                    }
                },
                    error => {
                        this.spinnerService.hide();
                        this.toastr.error(Global.ERROR_MESSAGE, Global.TOASTR_ADMIN_KEY_DEFINITION_TITLE, { enableHtml: true });
                    });
        } else {
