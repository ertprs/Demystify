...
export class RBIECBPopupUserComponent {
    ...
    GetRBIDataDetail() {
        ...
        this._rBIDataService.getRBIData(getRBIDataRequest)
            .subscribe(data => {
                ...
                let rBIDataId = (data.Response.length > 0) ? data.Response.filter(x => x.RBIDataName == Global.RBIDATA_ECB_NAME)[0].RBIDataId : null;
