...
export class SupportTicketUserService {
    ...
    getSupportTicket(getSupportTicketRequest: GetSupportTicketRequest): Observable<any> {
        ...
        return this._httpClient.get(Global.API_SITE + "user/api/supporttickets",{ params: params });
    }
    ...
    addSupportTicket(model: any): Observable<any> {
        ...
        return this._httpClient.post(Global.API_SITE + "user/api/supporttickets/add", body, { headers: headers });
    }
}