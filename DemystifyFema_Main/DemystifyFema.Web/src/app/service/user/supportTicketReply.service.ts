...
export class SupportTicketReplyUserService {
    ...
    getSupportTicketReply(getSupportTicketReplyRequest: GetSupportTicketReplyRequest): Observable<any> {
        ...
        return this._httpClient.get(Global.API_SITE + "user/api/supportticketreplies",{ params: params });
    }
    ...
    addSupportTicketReply(model: any): Observable<any> {
        ...
        return this._httpClient.post(Global.API_SITE + "user/api/supportticketreplies/add", body, { headers: headers });
    }
}