...
export class UserProfileUserService {
    ...
    getUserProfile(getUserProfileRequest: GetUserProfileRequest): Observable<any> {
        ...
        return this._httpClient.get(Global.API_SITE + "user/api/userprofiles", { params: params });
    }
    ...
    updateProfile(model: any): Observable<any> {
        ...
        return this._httpClient.post(Global.API_SITE + "user/api/userprofiles/update", body, { headers: headers });
    }
    ...
    sendOTPForUserProfile(model: any): Observable<any> {
        ...
        let body = JSON.stringify(model);
        let headers = new HttpHeaders({ 'Content-Type': 'application/json'});        
        return this._httpClient.post(Global.API_SITE + "user/api/sendotpforuserprofile", body, { headers: headers });            
    }
}